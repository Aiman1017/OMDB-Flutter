...
import 'package:omdb_api_flutter_2/models/film.dart';
import 'package:omdb_api_flutter_2/widgets/second.dart';
import 'dart:convert';
      ...
      Padding(padding: EdgeInsets.all(10),
        child:
          Column(children: <Widget>[
            ...
            //Give the user controll to what to search
        ...
        child:ListView.builder(itemBuilder: (BuildContext context, int index){
          ...
          Card(child: 
            ListTile(
              ...
              onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => Detail(imdbID: films[index].imdbId,)));
        },
      ),
    );
  },
